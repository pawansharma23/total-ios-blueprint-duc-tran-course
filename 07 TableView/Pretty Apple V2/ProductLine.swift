...
class ProductLine
{
    ...
    var products: [Product]     // all products (array of Products) in the line
    
    // That init instances variables
    ...
    // Return an array of ProductLine
    ...
    private class func iDevices() -> ProductLine {
        ...
        products.append(Product(titled: "iPad", description: "iPad Air 2 is the thinnest and most powerful iPad ever.", imageName: "ipad-air2.png"))
